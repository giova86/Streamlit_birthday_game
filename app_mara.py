...
def main_page():    # if os.path.isfile('config.ini') or os.path.isfile('../config.ini'):
    ...
    st.markdown('<h2 class="centered-title title">🎉️ Cara Mara, <br>i regali vanno sudati 🎉️</h2><h3 class="centered-title subtitle">- Trova il codice segreto per sbloccare il regalo -</h3>', unsafe_allow_html=True)
